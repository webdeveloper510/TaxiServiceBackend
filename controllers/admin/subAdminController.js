...
const { isDriverHasCompanyAccess , dateFilter , createCustomAccount , sendAccountDeactivationEmail , sendAccountReactivationEmail , companyHotelAccountCreationEmail , adminAccountCreationEmail} = require("../../Service/helperFuntion");
...
exports.add_sub_admin = async (req, res) => {
  try {
    ...
    if (!save_data) {
      ...
      // send welcome email
      companyHotelAccountCreationEmail(data , passwordEmail)
...
exports.add_admin = async (req, res) => {
  ...
  try {
    ...
    if (!save_data) {
      ...
      adminAccountCreationEmail(data , passwordEmail )
