...
router.put("/drivers/:driverId", [verifyToken , adminAuth ], driverController.adminUpdateDriver);
router.put("/restore_driver/:id", [verifyToken], driverController.restoreDriver);
...
router.put("/drivers/:driverId/documents/:docType/status",[verifyToken , adminAuth],driverController.updateDriverDocumentStatus);
...
router.post("/distance-matrix",tripController.distanceMatrix);
router.post("/calculate_price/:companyId",tripController.calculatePrice); // for outer booking link and driver account access
router.post("/calculate_price/",[verifyToken] , tripController.calculatePrice); // for company , partner account access and Hotel
...
router.post("/company_transaction",[verifyToken , companyAuth],paymentController.companyTransaction);
...
router.post("/sms-buy-create-ideal-checkout-session",[verifyToken , companyAuth] ,subscriptionController.smsBuyCreateIdealCheckoutSession);// IDEAL  functionality
router.post("/sms-payment-validate-session" ,subscriptionController.smsPaymentValidateSession);// checking if payment has been done
router.get("/sms-recharges" ,[verifyToken , companyAuth] ,subscriptionController.smsRecharges);// top-up list
router.get("/sms-transaction-list" ,[verifyToken , companyAuth] ,subscriptionController.smsTransactionList);// top-up list
